...
public abstract class ContainersDocumentProviderBase extends android.provider.DocumentsProvider
{
    ...
    {
        return DocumentIdRegistry.getInstance().register(uri);
    }
    ...
    {
        return DocumentIdRegistry.getInstance().resolve(documentId);
    }
    ...
    public Cursor queryDocument(String documentId, String[] projection) throws FileNotFoundException
    {
        ...
        {
            throw new IllegalArgumentException("Wrong document uri");
        }
    }
    ...
    public Cursor queryChildDocuments(String parentDocumentId, String[] projection, String sortOrder) throws FileNotFoundException
    {
        ...
        {
            throw new IllegalArgumentException("Wrong folder uri");
        }
    }
    ...
    {
        DocumentIdRegistry.getInstance().clear();
    ...
    public String renameDocument(String documentId, String displayName) throws FileNotFoundException
    {
        ...
        {
            throw new IllegalArgumentException("Rename failed");
        }
    }
    ...
    public boolean isChildDocument(String parentDocumentId, String documentId)
    {
        ...
        {
            throw new IllegalArgumentException("isChildDocument failed");
        }
    }
