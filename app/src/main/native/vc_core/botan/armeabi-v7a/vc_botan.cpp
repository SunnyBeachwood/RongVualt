...
* 'configure.py --os=android --cpu=arm32 --cc=clang --amalgamation --name-amalgamation=vc_botan_armv7 --build-targets=static --without-compilation-database --minimized-build --enable-modules=aes,serpent,twofish,camellia,kuznyechik,xts,pbkdf2,hmac,sha2_64,sha2_32,blake2s,whirlpool,streebog,argon2 --with-build-dir=C:/Users/QinQin/AppData/Local/Temp/botan-arm32 --prefix=C:/Users/QinQin/AppData/Local/Temp/botan-prefix-arm32'
*
* Target
*  - Compiler: clang++ -fstack-protector -pthread -std=c++20 -D_REENTRANT -O3
*  - Arch: arm32
*  - OS: android
*/
...
#define BOTAN_COMPILER_INVOCATION_STRING "clang++ -fstack-protector -pthread -O3"
...
*/
#define BOTAN_TARGET_ARCH "arm32"
...
* System paths
*/
#define BOTAN_INSTALL_PREFIX R"(C:/Users/QinQin/AppData/Local/Temp/botan-prefix-arm32)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-3)"
#define BOTAN_INSTALL_LIB_DIR R"(C:/Users/QinQin/AppData/Local/Temp/botan-prefix-arm32\lib)"
...
#define BOTAN_FULL_VERSION_STRING "Botan 3.12.0 (unreleased)"
