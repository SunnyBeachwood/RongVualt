...
class TextEditorFragment : Fragment(), ConfirmReloadDialogFragment.Listener,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Internal paths inherit their mounted tree's read-only state. For a
        // file handed in by another app, never assume write access unless its
        // temporary URI grant explicitly includes it.
        val externalUri = args.intent.data
        isWritable = !argsFile.fileSystem.isReadOnly && (externalUri == null ||
