...
private val mimeTypeToIconMap = mapOf(
    ...
    "application/x-brotli" to MimeTypeIcon.ARCHIVE,
    ...
    "application/x-lz4" to MimeTypeIcon.ARCHIVE,
    ...
    "application/x-rpm" to MimeTypeIcon.ARCHIVE,
    "application/x-rar" to MimeTypeIcon.ARCHIVE,
    "application/vnd.ms-htmlhelp" to MimeTypeIcon.ARCHIVE,
    ...
    "application/x-zip-compressed" to MimeTypeIcon.ARCHIVE,
