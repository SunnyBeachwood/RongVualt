...
object Settings {
    val STORAGES: SettingLiveData<List<Storage>> =
        SecureParcelValueSettingLiveData(
    ...
    val FTP_SERVER_PASSWORD: SettingLiveData<String> =
        CredentialStringSettingLiveData(
    ...
    /** Whether returning from the background must cross RongVault's app lock. */
    val REQUIRE_APP_AUTHENTICATION_ON_RETURN: SettingLiveData<Boolean> =
        BooleanSettingLiveData(
            R.string.pref_key_require_app_authentication_on_return,
            R.bool.pref_default_value_require_app_authentication_on_return,
        )
    ...
    val MARKDOWN_RENDERING_ENABLED: SettingLiveData<Boolean> =
        BooleanSettingLiveData(
            R.string.pref_key_markdown_rendering_enabled,
            R.bool.pref_default_value_markdown_rendering_enabled
        )
}
